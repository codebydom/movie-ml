...
ratings <- fread(text = gsub("::", "\t", readLines("<your path to ml folder>/ml-10M100K/ratings.dat")),
                 col.names = c("userId", "movieId", "rating", "timestamp"))

movies <- str_split_fixed(readLines("<your path to ml folder>/ml-10M100K/movies.dat"), "\\::", 3)
